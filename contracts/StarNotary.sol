...
contract StarNotary is ERC721 {
    ...
    string public constant symbol = "AWST";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        string memory starName = myStar.name;
        return starName ;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender==ownerOf(_tokenId1) || msg.sender==ownerOf(_tokenId2), "you need to be the owner of one star");
